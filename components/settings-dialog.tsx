...
import { 
    ...
    Volume2, RadioTower, LogOut, Save, UploadCloud, DollarSign
} from 'lucide-react';
...
interface SettingsDialogProps {
  ...
  isProModelsEnabled: boolean; // Added this prop
  onToggleProModelsEnabled: (enabled: boolean) => void; // Added this prop
          ...
          <TabsContent value="customization" className="flex-1 outline-none overflow-y-auto dialog-custom-scrollbar">
            <div className="p-4 sm:p-6 space-y-6">
              <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg border bg-card"><Label htmlFor="pm-toggle" className="text-sm cursor-pointer flex items-center gap-2"><DollarSign className="h-4 w-4 text-muted-foreground"/>Enable Pro Models</Label><Switch id="pm-toggle" checked={props.isProModelsEnabled} onCheckedChange={props.onToggleProModelsEnabled} /></div>
